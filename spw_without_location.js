(function() {
    ...
    class SocialProofWidget {
            ...
            return [
                {
                    ...
                    action: 'just joined the REtipster Community!'
                },
                {
                    name: 'John Doe',
                    location: 'US',
        ...
        async displayNotification(notification) {
            ...
            messageEl.textContent = `${notification.name} ${action}`;
    ...
    function autoInitialize() {
        const scripts = document.querySelectorAll('script[src*="spw_without_location.js"]');
